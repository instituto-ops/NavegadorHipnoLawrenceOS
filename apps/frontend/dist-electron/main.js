import St, { dialog as fc, app as qr, BrowserWindow as Ol } from "electron";
...
function We() {
  return Sa || (Sa = 1, Sr.fromCallback = function(n) {
    return Object.defineProperty(function(...d) {
      if (typeof d[d.length - 1] == "function") n.apply(this, d);
        ...
        return new Promise((p, c) => {
          d.push((f, u) => f != null ? c(f) : p(u)), n.apply(this, d);
        });
    }, "name", { value: n.name });
    ...
    return Object.defineProperty(function(...d) {
      ...
      d.pop(), n.apply(this, d).then((c) => p(null, c), p);
    }, "name", { value: n.name });
  }), Sr;
}
var Qr, Ca;
function mc() {
  if (Ca) return Qr;
  Ca = 1;
  var n = hc, d = process.cwd, p = null, c = process.env.GRACEFUL_FS_PLATFORM || process.platform;
  ...
  Qr = u;
  function u(a) {
    n.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && l(a), a.lutimes || o(a), a.chown = t(a.chown), a.fchown = t(a.fchown), a.lchown = t(a.lchown), a.chmod = s(a.chmod), a.fchmod = s(a.fchmod), a.lchmod = s(a.lchmod), a.chownSync = r(a.chownSync), a.fchownSync = r(a.fchownSync), a.lchownSync = r(a.lchownSync), a.chmodSync = i(a.chmodSync), a.fchmodSync = i(a.fchmodSync), a.lchmodSync = i(a.lchmodSync), a.stat = h(a.stat), a.fstat = h(a.fstat), a.lstat = h(a.lstat), a.statSync = g(a.statSync), a.fstatSync = g(a.fstatSync), a.lstatSync = g(a.lstatSync), a.chmod && !a.lchmod && (a.lchmod = function(m, _, T) {
    ...
    function l(m) {
      m.lchmod = function(_, T, P) {
        ...
        var P = m.openSync(_, n.O_WRONLY | n.O_SYMLINK, T), O = !0, b;
        try {
    ...
    function o(m) {
      n.hasOwnProperty("O_SYMLINK") && m.futimes ? (m.lutimes = function(_, T, P, O) {
        m.open(_, n.O_SYMLINK, function(b, I) {
          if (b) {
            O && O(b);
            return;
          }
        ...
        var O = m.openSync(_, n.O_SYMLINK), b, I = !0;
        try {
...
function gc() {
  ...
  function d(p) {
    ...
    function c(u, a) {
      ...
      p.open(this.path, this.flags, this.mode, function(r, h) {
        if (r) {
...
function je() {
  if (Oa) return Cr;
  Oa = 1;
  var n = ht, d = mc(), p = gc(), c = vc(), f = Qi, u, a;
...
GFS4: `), console.error(m);
    ...
    var i = Je[u] || [];
    o(n, i), n.close = (function(m) {
      function _(T, P) {
        return m.call(n, T, function(O) {
  ...
  function t(m) {
    d(m), m.gracefulify = t, m.createReadStream = de, m.createWriteStream = ie;
    var _ = m.readFile;
    m.readFile = T;
    function T(Q, ge, w) {
  ...
  function r(m) {
    s("ENQUEUE", m[0].name, m[1]), n[u].push(m), y();
  }
  var h;
  function g() {
    for (var m = Date.now(), _ = 0; _ < n[u].length; ++_)
      n[u][_].length > 2 && (n[u][_][3] = m, n[u][_][4] = m);
    y();
  }
  function y() {
    if (clearTimeout(h), h = void 0, n[u].length !== 0) {
      var m = n[u].shift(), _ = m[0], T = m[1], P = m[2], O = m[3], b = m[4];
      if (O === void 0)
        ...
        S >= E ? (s("RETRY", _.name, T), _.apply(null, T.concat([O]))) : n[u].push(m);
      }
...
function $t() {
  return Ia || (Ia = 1, (function(n) {
    ...
    }, typeof p.writev == "function" && (n.writev = function(f, u, ...a) {
      return typeof a[a.length - 1] == "function" ? p.writev(f, u, ...a) : new Promise((l, o) => {
        p.writev(f, u, ...a, (s, i, t) => {
          if (s) return o(s);
...
function Ec() {
  ...
  Da = 1;
  const n = Ie;
  return tn.checkPath = function(p) {
...
function yc() {
  if (Na) return br;
  Na = 1;
  const n = /* @__PURE__ */ $t(), { checkPath: d } = /* @__PURE__ */ Ec(), p = (c) => {
    const f = { mode: 511 };
...
function tt() {
  if (Fa) return rn;
  Fa = 1;
  const n = We().fromPromise, { makeDir: d, makeDirSync: p } = /* @__PURE__ */ yc(), c = n(d);
  return rn = {
    mkdirs: c,
    mkdirsSync: p,
    // alias
...
function Mt() {
  ...
  function f(r, h, g) {
    let y;
    const m = g.dereference ? (T) => n.statSync(T, { bigint: !0 }) : (T) => n.lstatSync(T, { bigint: !0 }), _ = m(r);
    try {
      y = m(h);
    } catch (T) {
  ...
  function u(r, h, g, y, m) {
    p.callbackify(c)(r, h, y, (_, T) => {
      if (_) return m(_);
      ...
      if (O) {
        ...
        if (P.isDirectory() && !O.isDirectory())
          return m(new Error(`Cannot overwrite non-directory '${h}' with directory '${r}'.`));
        if (!P.isDirectory() && O.isDirectory())
          return m(new Error(`Cannot overwrite directory '${h}' with non-directory '${r}'.`));
      }
      return P.isDirectory() && i(r, h) ? m(new Error(t(r, h, g))) : m(null, { srcStat: P, destStat: O });
    });
  }
  function a(r, h, g, y) {
    const { srcStat: m, destStat: _ } = f(r, h, y);
    if (_) {
      if (s(m, _)) {
    ...
    if (m.isDirectory() && i(r, h))
      throw new Error(t(r, h, g));
    return { srcStat: m, destStat: _ };
  }
  function l(r, h, g, y, m) {
    const _ = d.resolve(d.dirname(r)), T = d.resolve(d.dirname(g));
    if (T === _ || T === d.parse(T).root) return m();
    n.stat(T, { bigint: !0 }, (P, O) => P ? P.code === "ENOENT" ? m() : m(P) : s(h, O) ? m(new Error(t(r, g, y))) : l(r, h, T, y, m));
  }
  function o(r, h, g, y) {
    const m = d.resolve(d.dirname(r)), _ = d.resolve(d.dirname(g));
  ...
  function i(r, h) {
    const g = d.resolve(r).split(d.sep).filter((m) => m), y = d.resolve(h).split(d.sep).filter((m) => m);
...
function wc() {
  if (ka) return sn;
  ka = 1;
  const n = je(), d = Ie, p = tt().mkdirs, c = Ct().pathExists, f = xl().utimesMillis, u = /* @__PURE__ */ Mt();
  function a(q, L, $, x) {
  ...
  function g(q, L, $, x) {
    return y(q) ? m($, q, (N) => N ? x(N) : _(q, L, $, x)) : _(q, L, $, x);
  }
  function y(q) {
    return (q & 128) === 0;
  }
...
function _c() {
  if (qa) return ln;
  qa = 1;
  const n = je(), d = Ie, p = tt().mkdirsSync, c = xl().utimesMillisSync, f = /* @__PURE__ */ Mt();
  function u(S, A, E) {
  ...
  function a(S, A, E, k) {
    ...
    const q = d.dirname(E);
    return n.existsSync(q) || p(q), o(S, A, E, k);
  }
  function l(S, A, E, k) {
...
function Rc() {
  if (Ma) return cn;
  Ma = 1;
  const n = je(), d = Ie, p = Il, c = process.platform === "win32";
  function f(g) {
    [
      "unlink",
      "chmod",
  ...
  function o(g, y, m) {
    ...
    _.isDirectory() ? r(g, y, m) : y.unlinkSync(g);
  }
  function s(g, y, m, _) {
  ...
  function h(g, y) {
    if (p(g), p(y), y.readdirSync(g).forEach((m) => t(d.join(g, m), y)), c) {
      const m = Date.now();
      do
        try {
...
function Br() {
  if (Ba) return fn;
  Ba = 1;
  const n = je(), d = We().fromCallback, p = /* @__PURE__ */ Rc();
  function c(u, a) {
...
function Ac() {
  if (Ha) return dn;
  Ha = 1;
  const n = We().fromPromise, d = /* @__PURE__ */ $t(), p = Ie, c = /* @__PURE__ */ tt(), f = /* @__PURE__ */ Br(), u = n(async function(o) {
    let s;
    try {
      s = await d.readdir(o);
    } catch {
...
function Tc() {
  if (ja) return hn;
  ja = 1;
  const n = We().fromCallback, d = Ie, p = je(), c = /* @__PURE__ */ tt();
  function f(a, l) {
    function o() {
      p.writeFile(a, "", (s) => {
        if (s) return l(s);
...
function Sc() {
  if (Ga) return pn;
  Ga = 1;
  const n = We().fromCallback, d = Ie, p = je(), c = /* @__PURE__ */ tt(), f = Ct().pathExists, { areIdentical: u } = /* @__PURE__ */ Mt();
  function a(o, s, i) {
    function t(r, h) {
      p.link(r, h, (g) => {
        if (g) return i(g);
  ...
  function l(o, s) {
    ...
    const t = d.dirname(s);
    return p.existsSync(t) || c.mkdirsSync(t), p.linkSync(o, s);
  }
  return pn = {
    createLink: n(a),
    createLinkSync: l
...
function Cc() {
  if (Wa) return mn;
  Wa = 1;
  const n = Ie, d = je(), p = Ct().pathExists;
  function c(u, a, l) {
    if (n.isAbsolute(u))
...
function Pc() {
  if (Ya) return vn;
  Ya = 1;
  const n = We().fromCallback, d = Ie, p = /* @__PURE__ */ $t(), c = /* @__PURE__ */ tt(), f = c.mkdirs, u = c.mkdirsSync, a = /* @__PURE__ */ Cc(), l = a.symlinkPaths, o = a.symlinkPathsSync, s = /* @__PURE__ */ bc(), i = s.symlinkType, t = s.symlinkTypeSync, r = Ct().pathExists, { areIdentical: h } = /* @__PURE__ */ Mt();
  function g(_, T, P, O) {
  ...
  function m(_, T, P) {
    ...
    if (O && O.isSymbolicLink()) {
      const A = p.statSync(_), E = p.statSync(T);
      if (h(A, E)) return;
    }
    const b = o(_, T);
...
function Oc() {
  if (za) return En;
  za = 1;
  const { createFile: n, createFileSync: d } = /* @__PURE__ */ Tc(), { createLink: p, createLinkSync: c } = /* @__PURE__ */ Sc(), { createSymlink: f, createSymlinkSync: u } = /* @__PURE__ */ Pc();
  return En = {
    // file
    createFile: n,
    createFileSync: d,
...
function Ic() {
  ...
  const d = We(), { stringify: p, stripBom: c } = ea();
...
function ta() {
  if (Qa) return Rn;
  Qa = 1;
  const n = We().fromCallback, d = je(), p = Ie, c = /* @__PURE__ */ tt(), f = Ct().pathExists;
  function u(l, o, s, i) {
...
function Lc() {
  if (ro) return Cn;
  ro = 1;
  const n = je(), d = Ie, p = Zi().copy, c = Br().remove, f = tt().mkdirp, u = Ct().pathExists, a = /* @__PURE__ */ Mt();
  function l(r, h, g, y) {
    ...
    a.checkPaths(r, h, "move", g, (_, T) => {
      ...
      a.checkParentPaths(r, P, h, "move", (b) => {
        if (b) return y(b);
        if (o(h)) return s(r, h, m, O, y);
        f(d.dirname(h), (I) => I ? y(I) : s(r, h, m, O, y));
      });
    });
  }
  function o(r) {
  ...
  function s(r, h, g, y, m) {
    if (y) return i(r, h, g, m);
    if (g)
      return c(h, (_) => _ ? m(_) : i(r, h, g, m));
    u(h, (_, T) => _ ? m(_) : T ? m(new Error("dest already exists.")) : i(r, h, g, m));
  }
  function i(r, h, g, y) {
    n.rename(r, h, (m) => m ? m.code !== "EXDEV" ? y(m) : t(r, h, g, y) : y());
  }
  function t(r, h, g, y) {
    p(r, h, {
      overwrite: g,
...
function Uc() {
  if (no) return bn;
  no = 1;
  const n = je(), d = Ie, p = Zi().copySync, c = Br().removeSync, f = tt().mkdirpSync, u = /* @__PURE__ */ Mt();
  function a(t, r, h) {
    h = h || {};
    const g = h.overwrite || h.clobber || !1, { srcStat: y, isChangingCase: m = !1 } = u.checkPathsSync(t, r, "move", h);
    return u.checkParentPathsSync(t, y, r, "move"), l(r) || f(d.dirname(r)), o(t, r, g, m);
  }
  function l(t) {
    const r = d.dirname(t);
...
function ra() {
  ...
  return At.CancellationError = p, At;
}
var Pr = {}, so;
function Hr() {
  if (so) return Pr;
...
function qc() {
  if (lo) return Dn;
  lo = 1;
  var n = 1e3, d = n * 60, p = d * 60, c = p * 24, f = c * 7, u = c * 365.25;
  Dn = function(i, t) {
    t = t || {};
    var r = typeof i;
  ...
  function l(i) {
    var t = Math.abs(i);
    return t >= c ? Math.round(i / c) + "d" : t >= p ? Math.round(i / p) + "h" : t >= d ? Math.round(i / d) + "m" : t >= n ? Math.round(i / n) + "s" : i + "ms";
  }
  function o(i) {
    var t = Math.abs(i);
    return t >= c ? s(i, t, c, "day") : t >= p ? s(i, t, p, "hour") : t >= d ? s(i, t, d, "minute") : t >= n ? s(i, t, n, "second") : i + " ms";
  }
  function s(i, t, r, h) {
    var g = t >= r * 1.5;
  ...
  function n(d) {
    ...
    function c(t) {
      ...
      function m(..._) {
        if (!m.enabled)
          return;
        const T = m, P = Number(/* @__PURE__ */ new Date()), O = P - (r || P);
      ...
      return m.namespace = t, m.useColors = c.useColors(), m.color = c.selectColor(t), m.extend = f, m.destroy = c.destroy, Object.defineProperty(m, "enabled", {
        enumerable: !0,
        configurable: !1,
...
function Mc() {
  return fo || (fo = 1, Fn = (n, d = process.argv) => {
    const p = n.startsWith("-") ? "" : n.length === 1 ? "-" : "--", c = d.indexOf(p + n), f = d.indexOf("--");
    return c !== -1 && (f === -1 || c < f);
  }), Fn;
}
var xn, ho;
function Bc() {
  if (ho) return xn;
  ho = 1;
  const n = Mr, d = Nl, p = Mc(), { env: c } = process;
  let f;
  ...
  return po || (po = 1, (function(n, d) {
    ...
    function u(r) {
      ...
      if (g) {
        ...
        r[0] = _ + r[0].split(`
`).join(`
` + _), r.push(m + "m+" + n.exports.humanize(this.diff) + "\x1B[0m");
      } else
        r[0] = a() + h + " " + r[0];
    }
    function a() {
...
function Gc() {
  if (vo) return ke;
  vo = 1, Object.defineProperty(ke, "__esModule", { value: !0 }), ke.DigestTransform = ke.HttpExecutor = ke.HttpError = void 0, ke.createHttpError = s, ke.parseJson = r, ke.configureRequestOptionsFromUrl = y, ke.configureRequestUrl = m, ke.safeGetHeader = P, ke.configureRequestOptions = b, ke.safeStringifyJson = I;
  const n = mr, d = jc(), p = ht, c = pr, f = pt, u = ra(), a = Hr(), l = Ul(), o = (0, d.default)("electron-builder");
  function s(S, A = null) {
...
function Vc() {
  if (yo) return Dt;
  yo = 1, Object.defineProperty(Dt, "__esModule", { value: !0 }), Dt.githubUrl = n, Dt.githubTagPrefix = d, Dt.getS3LikeProviderBaseUrl = p;
  ...
  async function d(p, c) {
    ...
    try {
      ...
      if (await Promise.resolve((f = s?.(t)) !== null && f !== void 0 ? f : !0) && u > 0 && !i.cancelled)
        return await new Promise((r) => setTimeout(r, a + l * o)), await d(p, { ...c, retries: u - 1, attempt: o + 1 });
      throw t;
    }
  }
  return Nr;
...
function Xc() {
  ...
  const n = mr, d = Hr(), p = "options.name must be either a string or a Buffer", c = (0, n.randomBytes)(16);
  c[0] = c[0] | 1;
  const f = {}, u = [];
  for (let t = 0; t < 256; t++) {
...
function Kc() {
  return Ao || (Ao = 1, (function(n) {
    (function(d) {
      ...
      function f(w) {
        for (var v = Math.max(d.MAX_BUFFER_LENGTH, 10), B = 0, F = 0, ce = p.length; F < ce; F++) {
          var he = w[p[F]].length;
          if (he > v)
            switch (p[F]) {
              case "textNode":
      ...
      var t = "[CDATA[", r = "DOCTYPE", h = "http://www.w3.org/XML/1998/namespace", g = "http://www.w3.org/2000/xmlns/", y = { xml: h, xmlns: g }, m = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, T = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, P = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
      function O(w) {
        return w === " " || w === `
` || w === "\r" || w === "	";
      }
...
` ? (v.line++, v.column = 0) : v.column++);
            ...
            case E.ATTRIB:
              if (O(F))
                continue;
              F === ">" ? de(v) : F === "/" ? v.state = E.OPEN_TAG_SLASH : S(m, F) ? (v.attribName = F, v.attribValue = "", v.state = E.ATTRIB_NAME) : D(v, "Invalid attribute name");
              continue;
            case E.ATTRIB_NAME:
            ...
            case E.ATTRIB_NAME_SAW_WHITE:
              if (F === "=")
                ...
                D(v, "Attribute without value"), v.tag.attributes[v.attribName] = "", v.attribValue = "", L(v, "onattribute", {
                  name: v.attribName,
                  value: ""
                }), v.attribName = "", F === ">" ? de(v) : S(m, F) ? (v.attribName = F, v.state = E.ATTRIB_NAME) : (D(v, "Invalid attribute name"), v.state = E.ATTRIB);
              }
              continue;
            case E.ATTRIB_VALUE:
              if (O(F))
            ...
            case E.ATTRIB_VALUE_CLOSED:
              O(F) ? v.state = E.ATTRIB : F === ">" ? de(v) : F === "/" ? v.state = E.OPEN_TAG_SLASH : S(m, F) ? (D(v, "No whitespace between attributes"), v.attribName = F, v.attribValue = "", v.state = E.ATTRIB_NAME) : D(v, "Invalid attribute name");
              continue;
            ...
            case E.CLOSE_TAG:
              if (v.tagName)
                ...
                if (O(F))
                  continue;
                A(m, F) ? v.script ? (v.script += "</" + F, v.state = E.SCRIPT) : D(v, "Invalid tagname in closing tag.") : v.tagName = F;
              }
              continue;
...
function gr() {
  ...
  return ct.isNothing = n, ct.isObject = d, ct.toArray = p, ct.repeat = f, ct.isNegativeZero = u, ct.extend = c, ct;
}
var Un, bo;
function vr() {
  if (bo) return Un;
...
` + p.mark.snippet), u + " " + f) : u;
  ...
  function d(p, c) {
    Error.call(this), this.name = "YAMLException", this.reason = p, this.mark = c, this.message = n(this, !1), Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : this.stack = new Error().stack || "";
  }
  ...
  function c(f, u) {
    ...
    for (r = 1; r <= u.linesBefore && !(i - r < 0); r++)
      h = d(
        ...
        y
      ), t = n.repeat(" ", u.indent) + p((f.line - r + 1).toString(), g) + " | " + h.str + `
` + t;
    for (h = d(f.buffer, l[i], o[i], f.position, y), t += n.repeat(" ", u.indent) + p((f.line + 1).toString(), g) + " | " + h.str + `
...
function zl() {
  ...
  function f(a) {
    var l, o, s, i, t, r, h, g = 0, y = null, m, _, T;
    ...
    return l[9] && (m = +l[10], _ = +(l[11] || 0), y = (m * 60 + _) * 6e4, l[9] === "-" && (y = -y)), T = new Date(Date.UTC(o, s, i, t, r, h, g)), y && T.setTime(T.getTime() - y), T;
  }
  function u(a) {
...
function Jl() {
  if (Go) return Zn;
  Go = 1;
  var n = Me(), d = Object.prototype.hasOwnProperty, p = Object.prototype.toString;
  function c(u) {
    if (u === null) return !0;
    var a = [], l, o, s, i, t, r = u;
    for (l = 0, o = r.length; l < o; l += 1) {
      if (s = r[l], t = !1, p.call(s) !== "[object Object]") return !1;
      for (i in s)
        if (d.call(s, i))
          if (!t) t = !0;
          else return !1;
...
function Zc() {
  if (zo) return xr;
  zo = 1;
  var n = gr(), d = vr(), p = Qc(), c = na(), f = Object.prototype.hasOwnProperty, u = 1, a = 2, l = 3, o = 4, s = 1, i = 2, t = 3, r = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, h = /[\x85\u2028\u2029]/, g = /[,\[\]\{\}]/, y = /^(?:!|!!|![a-z\-]+!)$/i, m = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
  function _(e) {
...
` : e === 118 ? "\v" : e === 102 ? "\f" : e === 114 ? "\r" : e === 101 ? "\x1B" : e === 32 ? " " : e === 34 ? '"' : e === 47 ? "/" : e === 92 ? "\\" : e === 78 ? "" : e === 95 ? " " : e === 76 ? "\u2028" : e === 80 ? "\u2029" : "";
  ...
  function j(e, H) {
    ...
    return W.snippet = p(W), new d(H, W);
  }
  function D(e, H) {
    throw j(e, H);
  }
...
function ef() {
  if (Xo) return ni;
  Xo = 1;
  var n = gr(), d = vr(), p = na(), c = Object.prototype.toString, f = Object.prototype.hasOwnProperty, u = 65279, a = 9, l = 10, o = 13, s = 32, i = 33, t = 34, r = 35, h = 37, g = 38, y = 39, m = 42, _ = 44, T = 45, P = 58, O = 61, b = 62, I = 63, S = 64, A = 91, E = 93, k = 96, q = 123, L = 124, $ = 125, x = {};
...
` + n.repeat(" ", R.indent * M);
  ...
  function B(R) {
    return ge(R) && R !== u && !Q(R) && R !== T && R !== I && R !== P && R !== _ && R !== A && R !== E && R !== q && R !== $ && R !== r && R !== g && R !== m && R !== i && R !== L && R !== O && R !== b && R !== y && R !== t && R !== h && R !== S && R !== k;
  }
  function F(R) {
    return !Q(R) && R !== P;
  }
...
function Be() {
  if (ns) return li;
  ns = 1;
  const n = Gr(), { MAX_LENGTH: d, MAX_SAFE_INTEGER: p } = jr(), { safeRe: c, t: f } = Er(), u = aa(), { compareIdentifiers: a } = eu();
  class l {
    constructor(s, i) {
...
function of() {
  ...
  const n = Bt();
  return hi = (p, c) => {
    const f = n(p, null, !0), u = n(c, null, !0), a = f.compare(u);
    if (a === 0)
      return null;
...
function sf() {
  ...
  us = 1;
  const n = Be();
  return pi = (p, c) => new n(p, c).major, pi;
}
var mi, cs;
function lf() {
  if (cs) return mi;
  cs = 1;
  const n = Be();
  return mi = (p, c) => new n(p, c).minor, mi;
}
var gi, fs;
function uf() {
  if (fs) return gi;
  fs = 1;
  const n = Be();
  return gi = (p, c) => new n(p, c).patch, gi;
}
var vi, ds;
function cf() {
  if (ds) return vi;
...
function Qe() {
  ...
  hs = 1;
  const n = Be();
  return Ei = (p, c, f) => new n(p, f).compare(new n(c, f)), Ei;
}
var yi, ps;
function ff() {
  if (ps) return yi;
...
function hf() {
  ...
  vs = 1;
  const n = oa();
  return Ri = (p, c) => p.sort((f, u) => n(f, u, c)), Ri;
}
var Ai, Es;
function pf() {
  if (Es) return Ai;
  Es = 1;
  const n = oa();
  return Ai = (p, c) => p.sort((f, u) => n(u, f, c)), Ai;
}
var Ti, ys;
function Wr() {
  if (ys) return Ti;
...
function ua() {
  ...
  Ts = 1;
  const n = Qe();
  return Oi = (p, c, f) => n(p, c, f) <= 0, Oi;
}
var Ii, Ss;
function nu() {
  if (Ss) return Ii;
  Ss = 1;
  const n = tu(), d = ru(), p = Wr(), c = la(), f = sa(), u = ua();
  return Ii = (l, o, s, i) => {
    switch (o) {
      case "===":
...
function mf() {
  if (Cs) return Di;
  Cs = 1;
  const n = Be(), d = Bt(), { safeRe: p, t: c } = Er();
  return Di = (u, a) => {
    if (u instanceof n)
      return u;
...
function Ze() {
  ...
  Fi = d;
  const p = gf(), c = new p(), f = aa(), u = Vr(), a = Gr(), l = Be(), {
    safeRe: o,
    t: s,
    comparatorTrimReplace: i,
    tildeTrimReplace: t,
    caretTrimReplace: r
  } = Er(), { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: g } = jr(), y = (x) => x.value === "<0.0.0-0", m = (x) => x.value === "", _ = (x, N) => {
    let j = !0;
    const D = x.slice();
    let G = D.pop();
    for (; j && D.length; )
...
function vf() {
  ...
  Ds = 1;
  const n = Ze();
  return Ui = (p, c) => new n(p, c).set.map((f) => f.map((u) => u.value).join(" ").trim().split(" ")), Ui;
}
var ki, Ns;
function Ef() {
  if (Ns) return ki;
...
function ca() {
  if (Us) return Bi;
  Us = 1;
  const n = Be(), d = Vr(), { ANY: p } = d, c = Ze(), f = Yr(), u = Wr(), a = sa(), l = ua(), o = la();
  return Bi = (i, t, r, h) => {
...
function Tf() {
  ...
  $s = 1;
  const n = Ze();
  return Gi = (p, c, f) => (p = new n(p, f), c = new n(c, f), p.intersects(c, f)), Gi;
}
var Wi, Ms;
function Sf() {
  if (Ms) return Wi;
...
function Cf() {
  if (Bs) return Vi;
  Bs = 1;
  const n = Ze(), d = Vr(), { ANY: p } = d, c = Yr(), f = Qe(), u = (t, r, h = {}) => {
    if (t === r)
      return !0;
...
function iu() {
  if (Hs) return Yi;
  Hs = 1;
  const n = Er(), d = jr(), p = Be(), c = eu(), f = Bt(), u = rf(), a = nf(), l = af(), o = of(), s = sf(), i = lf(), t = uf(), r = cf(), h = Qe(), g = ff(), y = df(), m = oa(), _ = hf(), T = pf(), P = Wr(), O = sa(), b = tu(), I = ru(), S = la(), A = ua(), E = nu(), k = mf(), q = Vr(), L = Ze(), $ = Yr(), x = vf(), N = Ef(), j = yf(), D = wf(), G = _f(), V = ca(), te = Rf(), de = Af(), ie = Tf(), we = Sf(), ve = Cf();
  return Yi = {
    parse: f,
    valid: u,
    clean: a,
...
function Pf() {
  ...
  const n = mr, d = ht, p = bf(), c = /* @__PURE__ */ mt(), f = Ie;
  let u = class {
    constructor(s) {
    ...
    async validateDownloadedPath(s, i, t, r) {
      if (this.versionInfo != null && this.file === s && this.fileInfo != null)
        return p(this.versionInfo, i) && p(this.fileInfo.info, t.info) && await (0, c.pathExists)(s) ? s : null;
...
function Of() {
  if (Ws) return Ur;
  Ws = 1, Object.defineProperty(Ur, "__esModule", { value: !0 }), Ur.getAppCacheDir = p;
  const n = Ie, d = Mr;
  function p() {
    const c = (0, d.homedir)();
    let f;
...
function If() {
  ...
  return zt.ElectronAppAdapter = p, zt;
}
var zi = {}, Ys;
function Df() {
...
function bt() {
  if (zs) return xt;
  zs = 1, Object.defineProperty(xt, "__esModule", { value: !0 }), xt.newBaseUrl = d, xt.newUrlFromBase = p, xt.getChannelFilename = c;
  const n = pt;
  function d(f) {
    const u = new n.URL(f);
...
function au() {
  if (Xs) return Xi;
  Xs = 1;
  var n = "[object Symbol]", d = /[\\^$.*+?()[\]{}|]/g, p = RegExp(d.source), c = typeof Je == "object" && Je && Je.Object === Object && Je, f = typeof self == "object" && self && self.Object === Object && self, u = c || f || Function("return this")(), a = Object.prototype, l = a.toString, o = u.Symbol, s = o ? o.prototype : void 0, i = s ? s.toString : void 0;
  function t(m) {
    if (typeof m == "string")
      return m;
    if (h(m))
  ...
  function h(m) {
    return typeof m == "symbol" || r(m) && l.call(m) == n;
  }
  function g(m) {
    return m == null ? "" : t(m);
  }
...
function Ve() {
  ...
  const n = xe(), d = ia(), p = pt, c = bt(), f = au();
  let u = class {
    constructor(t) {
    ...
    getBlockMapFiles(t, r, h, g = null) {
      ...
      return [(0, c.newUrlFromBase)(`${t.pathname.replace(new RegExp(f(h), "g"), r)}.blockmap`, g ? new p.URL(g) : t), y];
    }
  ...
  function a(i, t, r) {
    ...
    const g = i.filter((m) => m.url.pathname.toLowerCase().endsWith(`.${t.toLowerCase()}`)), y = (h = g.find((m) => [m.url.pathname, m.info.url].some((_) => _.includes(process.arch)))) !== null && h !== void 0 ? h : g.shift();
    return y || (r == null ? i[0] : i.find((m) => !r.some((_) => m.url.pathname.toLowerCase().endsWith(`.${_.toLowerCase()}`))));
  }
  function l(i, t, r) {
    if (i == null)
  ...
  function s(i, t, r = (h) => h) {
    ...
    return m != null && (g[0].packageInfo = {
      ...m,
      path: (0, c.newUrlFromBase)(r(m.path), t).href
    }), g;
  }
  return at;
}
...
function su() {
  ...
  const n = xe(), d = iu(), p = pt, c = bt(), f = Ve(), u = /\/tag\/([^/]+)$/;
  ...
  let l = class extends a {
    ...
    async getLatestVersion() {
      var t, r, h, g, y;
      const m = new n.CancellationToken(), _ = await this.httpRequest((0, c.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
...
${_}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    async getLatestTagName(t) {
      const r = this.options, h = r.host == null || r.host === "github.com" ? (0, c.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new p.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
      try {
...
function Ff() {
  ...
  const n = xe(), d = pt, p = au(), c = bt(), f = Ve();
...
function Lf() {
  ...
  const n = xe(), d = ia(), p = Ie, c = pt, f = bt(), u = su(), a = Ve();
  let l = class extends u.BaseGitHubProvider {
    ...
    resolveFiles(s) {
      return (0, a.getFileList)(s).map((i) => {
        const t = p.posix.basename(i.url).replace(/ /g, "-"), r = s.assets.find((h) => h != null && h.name === t);
        if (r == null)
...
function Uf() {
  ...
  const n = xe(), d = Nf(), p = ou(), c = su(), f = Ff(), u = xf(), a = Lf();
  function l(s) {
...
function lu() {
  ...
  const n = xe(), d = ht, p = pr, c = fa(), f = Buffer.from(`\r
\r
`);
  var u;
  (function(o) {
  ...
  let l = class extends p.Writable {
    constructor(s, i, t, r, h, g, y, m) {
      super(), this.out = s, this.options = i, this.partIndexToTaskIndex = t, this.partIndexToLength = h, this.finishHandler = g, this.grandTotalBytes = y, this.onProgress = m, this.start = Date.now(), this.nextUpdate = this.start + 1e3, this.transferred = 0, this.delta = 0, this.partIndex = -1, this.headerListBuffer = null, this.readState = u.INIT, this.ignoreByteCount = 0, this.remainingPartDataCount = 0, this.actualPartLength = 0, this.boundaryLength = r.length + 4, this.ignoreByteCount = this.boundaryLength - 2;
    }
    get isFinished() {
...
function kf() {
  ...
  function f(a, l, o, s, i) {
    ...
    for (let T = l.start; T < l.end; T++) {
      const P = l.tasks[T];
      P.kind === p.OperationKind.DOWNLOAD && (t += `${P.start}-${P.end - 1}, `, g.set(r, T), r++, y.push(P.end - P.start), h += P.end - P.start);
    }
    if (r <= 1) {
      const T = (P) => {
        if (P >= l.end) {
...
function qf() {
  ...
  return ir.ProgressDifferentialDownloadCallbackTransform = p, ir;
}
var ll;
function uu() {
  if (ll) return rr;
  ll = 1, Object.defineProperty(rr, "__esModule", { value: !0 }), rr.DifferentialDownloader = void 0;
  const n = xe(), d = /* @__PURE__ */ mt(), p = ht, c = lu(), f = pt, u = fa(), a = kf(), l = qf();
  let o = class {
    ...
    downloadFile(r) {
      ...
      return this.doDownloadFile(r, h).then(g).catch((y) => g().catch((m) => {
        try {
    ...
    request(r, h) {
      return new Promise((g, y) => {
        const m = this.httpExecutor.createRequest(r, (_) => {
...
function da() {
  ...
  const n = xe(), d = mr, p = Mr, c = Dl, f = /* @__PURE__ */ mt(), u = ia(), a = tf(), l = Ie, o = iu(), s = Pf(), i = If(), t = Df(), r = ou(), h = Uf(), g = Fl, y = $f(), m = Pt();
...
function ml() {
  ...
  const n = xe(), d = $r, p = /* @__PURE__ */ mt(), c = ht, f = Ie, u = zr(), a = fu(), l = Ve(), o = Pt();
  let s = class extends u.BaseUpdater {
    ...
    doDownloadUpdate(t) {
      ...
      return this.executeDownload({
        ...
        task: async (g, y) => {
          ...
          (t.disableDifferentialDownload || await this.downloadDifferential(h, m, g, r, t)) && await this.httpExecutor.download(h.url, g, y), await (0, p.chmod)(g, 493);
        }
      });
    }
    async downloadDifferential(t, r, h, g, y) {
      try {
        ...
        return this.listenerCount(o.DOWNLOAD_PROGRESS) > 0 && (m.onProgress = (_) => this.emit(o.DOWNLOAD_PROGRESS, _)), await new a.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, m).download(), !1;
      } catch (m) {
...
function El() {
  ...
  const n = Ve(), d = Pt(), p = ha();
  let c = class du extends p.LinuxUpdater {
    constructor(u, a) {
      super(u, a);
    }
    /*** @private */
...
function wl() {
  ...
  const n = Pt(), d = Ve(), p = ha();
  let c = class hu extends p.LinuxUpdater {
    constructor(u, a) {
      super(u, a);
    }
    /*** @private */
...
function Rl() {
  ...
  const n = Pt(), d = Ve(), p = ha();
  let c = class pu extends p.LinuxUpdater {
    constructor(u, a) {
      super(u, a);
    }
    /*** @private */
...
function Tl() {
  ...
  const n = xe(), d = /* @__PURE__ */ mt(), p = ht, c = Ie, f = pc, u = da(), a = Ve(), l = $r, o = mr;
  let s = class extends u.AppUpdater {
    ...
    async doDownloadUpdate(t) {
      ...
      m && r.some(_) ? r = r.filter((b) => m === _(b)) : r = r.filter((b) => !_(b));
    ...
    async updateDownloaded(t, r) {
      var h;
      const g = r.downloadedFile, y = (h = t.info.size) !== null && h !== void 0 ? h : (await (0, d.stat)(g)).size, m = this._logger, _ = `fileToProxy=${t.url.href}`;
      ...
      return await new Promise((P, O) => {
        ...
        this.server.on("request", (A, E) => {
          ...
          const L = (0, p.createReadStream)(g);
          L.on("error", ($) => {
            try {
              E.end();
            } catch (x) {
...
function Mf() {
  ...
  function u(s, i, t) {
    return new Promise((r, h) => {
      const g = i.replace(/'/g, "''");
      t.info(`Verifying signature ${g}`), (0, d.execFile)(...f(`"Get-AuthenticodeSignature -LiteralPath '${g}' | ConvertTo-Json -Compress"`, 20 * 1e3), (y, m, _) => {
        var T;
        try {
          if (y != null || _) {
            l(t, y, _, h), r(null);
...
function bl() {
  ...
  const n = xe(), d = Ie, p = zr(), c = fu(), f = Pt(), u = Ve(), a = /* @__PURE__ */ mt(), l = Mf(), o = pt;
  let s = class extends p.BaseUpdater {
    ...
    doDownloadUpdate(t) {
      ...
      return this.executeDownload({
        ...
        task: async (g, y, m, _) => {
          ...
          if (P && await this.differentialDownloadWebPackage(t, T, m, r))
            try {
    ...
    doInstall(t) {
      ...
      const y = () => {
        this.spawnLog(d.join(process.resourcesPath, "elevate.exe"), [r].concat(h)).catch((m) => this.dispatchError(m));
      };
      return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), y(), !0) : (this.spawnLog(r, h).catch((m) => {
        const _ = m.code;
        this._logger.info(`Cannot run installer: error code: ${_}, error message: "${m.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), _ === "UNKNOWN" || _ === "EACCES" ? y() : _ === "ENOENT" ? St.shell.openPath(r).catch((T) => this.dispatchError(T)) : this.dispatchError(m);
      }), !0);
    }
...
function Bf() {
  return Pl || (Pl = 1, (function(n) {
    var d = _t && _t.__createBinding || (Object.create ? (function(m, _, T, P) {
      P === void 0 && (P = T);
...
var kt = Bf();
function Hf(n) {
  kt.autoUpdater.logger = console, kt.autoUpdater.checkForUpdatesAndNotify(), kt.autoUpdater.on("error", (d) => {
    console.error("Update error:", d);
  }), kt.autoUpdater.on("update-available", () => {
    console.warn("Update available");
  }), kt.autoUpdater.on("update-downloaded", (d) => {
    fc.showMessageBox({
      type: "info",
      title: "Nova versão disponível!",
      message: `A versão ${d.version} foi baixada e está pronta para ser instalada. Deseja reiniciar agora para atualizar?`,
      buttons: ["Sim, reiniciar agora", "Lembrar mais tarde"],
      defaultId: 0,
      cancelId: 1
    }).then((p) => {
      p.response === 0 && kt.autoUpdater.quitAndInstall();
    }).catch((p) => {
      console.error(p);
    });
  });
