...
import { Send, TerminalSquare, Image as ImageIcon, Loader2, Code2 } from 'lucide-react';
...
export const AgentChat: React.FC = () => {
  ...
  const {
      logs, julesLogs, screenshot, isConnected,
      isRunning, isJulesRunning, sendTask, sendJulesCommand
    ...
    <div className="flex flex-col h-screen max-w-[1400px] mx-auto p-4 bg-gray-50">
      <header className="mb-4 text-center">
        ...
        <p className="text-sm text-gray-500">
          Status: {isConnected ? <span className="text-green-600 font-semibold">Connected</span> : <span className="text-red-600 font-semibold">Disconnected</span>}
        </p>
      </header>
           ...
           <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-2">
            <form onSubmit={handleSubmit} className="flex gap-2">
              <input
                ...
                placeholder={!isConnected ? "Connecting..." : "Enter LAM task (e.g., 'Search Google for NeuroStrategy')"}
