...
export const JulesTerminal: React.FC<JulesTerminalProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#1e1e1e] rounded-xl shadow-sm border border-gray-800 overflow-hidden">
      ...
      <div className="p-2 border-t border-gray-800 bg-[#2d2d2d] focus-within:ring-1 focus-within:ring-blue-500/50">
        <form onSubmit={onSubmit} className="flex gap-2">
          <span className="text-green-500 font-mono py-2 pl-2" aria-hidden="true">
            ❯
          </span>
          <input
            type="text"
            ...
            aria-label="Jules Terminal Input"
