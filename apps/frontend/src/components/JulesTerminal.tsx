  ...
  return (
    <div className="flex-1 flex flex-col bg-[#1e1e1e] rounded-xl shadow-sm border border-gray-800 overflow-hidden">
      ...
      <div className="p-2 border-t border-gray-800 bg-[#2d2d2d]">
        <form
          onSubmit={onSubmit}
          className="flex gap-2 focus-within:ring-1 focus-within:ring-green-500 rounded-lg transition-all border border-transparent focus-within:border-green-500"
        >
          ...
          <input
            ...
            aria-label="Jules command line input"
