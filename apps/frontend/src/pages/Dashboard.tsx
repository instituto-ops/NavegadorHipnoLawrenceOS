...
export const Dashboard: React.FC = () => {
  ...
  // Consolidate redundant array traversals into a single-pass loop
  // Performance optimization: Reduces O(4n) traversal complexity to O(n)
